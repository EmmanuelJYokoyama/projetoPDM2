...
namespace projetoICG_2BIM
{
    public partial class Form1 : Form
    {
        ...
        {
            altura = Math.Abs(x - altura);
            largura  = Math.Abs(y - largura);
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (qtdPontos == 2)
            {
                DesenhaLinha(e, pen, coordenadas[pos], coordenadas[pos + 1], coordenadas[pos + 2], coordenadas[pos + 3]);
            } else if (qtdPontos == 3)
            {
                triangulo(e, pen, coordenadas[pos], coordenadas[pos + 1], coordenadas[pos + 2], coordenadas[pos + 3], coordenadas[pos + 4], coordenadas[pos + 5]);
            } else if (qtdPontos == 4)
            {
